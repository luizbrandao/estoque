...
<html lang="pt-br">
  ...
  <body>
    ...
    <div class="container">
      <nav class="navbar navbar-default">
        <div class="container-fluid">
          ...
          <ul class="nav navbar-nav navbar-right">
            <li><a href="http://localhost:8082/estoque/public/produtos">Listagem</a></li>
            <li><a href="http://localhost:8082/estoque/public/produtos/novo">Novo</a></li>
            @if(Auth::guest())
      ...
      @yield('conteudo')
      <script src="http://localhost:8082/estoque/public/js/jquery.min.js"></script>
      <script src="http://localhost:8082/estoque/public/js/bootstrap.js"></script>
    </div>
  </body>
</html>
